document.addEventListener('DOMContentLoaded', function() {
    ...
    const pricingData = {
        tier1: { // B2MS (1-10 users)
            oneYearMonthly: {
                total: { monthly: 2941.95, upfront: 0 }
            },
            oneYearUpfront: {
                total: { monthly: 2073.70, upfront: 10419.19 }
            },
            threeYearMonthly: {
                total: { monthly: 2628.80, upfront: 0 }
            },
            threeYearUpfront: {
                total: { monthly: 2073.70, upfront: 19981.33 }
            }
        },
        tier2: { // B4MS (11-20 users)
            oneYearMonthly: {
                total: { monthly: 4693.55, upfront: 0 }
            },
            oneYearUpfront: {
                total: { monthly: 2966.18, upfront: 20727.49 }
            },
            threeYearMonthly: {
                total: { monthly: 4076.20, upfront: 0 }
            },
            threeYearUpfront: {
                total: { monthly: 2966.18, upfront: 39962.67 }
            }
        }
    };
